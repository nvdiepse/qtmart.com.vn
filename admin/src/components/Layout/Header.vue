    ...
    <div class="col-full desktop-only">
      ...
      <div class="row align-items-center">
        ...
        <ul class="header-compare nav navbar-nav">
          <li class="nav-item">
            <router-link :class="nav - link" to="/so-sanh.html">
        ...
        <ul class="header-wishlist nav navbar-nav">
          <li class="nav-item">
            <router-link class="nav-link" to="/ua-thich.html">
        ...
        <ul id="site-header-cart" class="site-header-cart menu">
          <li class="animate-dropdown dropdown ">
            ...
            >
              ...
              <span class="amount">
                <span class="price-label">Giỏ hàng</span>&#036;136.99</span
              >
            </a>
                ...
                <div class="widget woocommerce widget_shopping_cart">
                  <div class="widget_shopping_cart_content">
                    ...
                    <p class="woocommerce-mini-cart__buttons buttons">
                      <router-link class="button wc-forward" to="/don-hang.html">
                        Chi tiết đơn hàng
                      </router-link>
                      <router-link class="button checkout wc-forward" to="/thanh-toan.html">
                        Thanh toán
                      </router-link>
                    </p>
                  </div>
