    ...
    <section class="column-1 deals-carousel" id="sale-with-timer-carousel">
      <div class="deals-carousel-inner-block">
        <header class="section-header">
          <h2 class="section-title"><strong>Ưu đãi</strong> trong tuần</h2>
                  ...
                  <div class="sale-product-with-timer product">
                    ...
                    >
                      ...
                      <div class="deal-countdown-timer">
                        ...
                        <!-- /.marketing-text -->
                        <span class="deal-time-diff" style="display:none;"
                          >28800</span
                        >
        ...
        <footer class="section-footer">
          <nav class="custom-slick-pagination">
            ...
            <a
              ...
              href="#"
              data-target="#sale-with-timer-carousel .products"
              >Next deal<i class="tm tm-arrow-right"></i
            ></a>
          </nav>
        </footer>
        <!-- /.section-footer -->
          ...
          <ul role="tablist" class="nav justify-content-end">
            <li class="nav-item">
              <a
                ...
                href="#tab-59f89f0881f930"
                data-toggle="tab"
                >Sản phẩm mới nổi bật</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link " href="#tab-59f89f0881f931" data-toggle="tab"
                >Sản phẩm giảm giá</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link " href="#tab-59f89f0881f932" data-toggle="tab"
                >Sản phẩm đánh giá tốt nhất</a
              >
            </li>
          </ul>
        </header>
