    ...
    <div class="col-full">
      <div class="row">
        <div class="products-carousel-tabs-block">
          <section
            class="section-hot-new-arrivals section-products-carousel-tabs 6-column-tabs"
          >
            <div class="section-products-carousel-tabs-wrap">
              <header class="section-header">
                ...
                <ul class="nav justify-content-end" role="tablist">
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-1-1" class="nav-link active"
                      >Top 20</a
                    >
                  </li>
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-1-2" class="nav-link "
                      >Audio &amp; Video</a
                    >
                  </li>
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-1-3" class="nav-link "
                      >Laptops &amp; Computers</a
                    >
                  </li>
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-1-4" class="nav-link "
                      >Video Cameras</a
                    >
                  </li>
                </ul>
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab-1-1" role="tabpanel">
                  <div
                    ...
                    data-wrap=".products"
                    data-slick='{"infinite":false,"slidesToShow":6,"slidesToScroll":6,"dots":true,"arrows":false,"responsive":[{"breakpoint":992,"settings":{"slidesToShow":2,"slidesToScroll":2}},{"breakpoint":1200,"settings":{"slidesToShow":3,"slidesToScroll":3}},{"breakpoint":1400,"settings":{"slidesToShow":3,"slidesToScroll":3}},{"breakpoint":1600,"settings":{"slidesToShow":4,"slidesToScroll":4}},{"breakpoint":1700,"settings":{"slidesToShow":5,"slidesToScroll":5}}]}'
                  >
                          ...
                          <div class="product">
                            ...
                            <div class="hover-area">
                              <a
                                ...
                                >Add to cart</a
                              >
                              <a class="add-to-compare-link" href="compare.html"
                                >Add to compare</a
                              >
                            </div>
                          </div>
          ...
          >
            <div class="section-products-carousel-tabs-wrap">
              <header class="section-header">
                ...
                <ul class="nav justify-content-end" role="tablist">
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-1" class="nav-link active"
                      >Best Choice</a
                    >
                  </li>
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-2" class="nav-link "
                      >Cardboards</a
                    >
                  </li>
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-3" class="nav-link "
                      >For Android</a
                    >
                  </li>
                  <li class="nav-item">
                    <a data-toggle="tab" href="#tab-4" class="nav-link "
                      >For ios</a
                    >
                  </li>
                </ul>
                ...
                >
                  <div class="caption">
                    <div class="banner-info">
                      ...
                      <h3 class="title">
                        <strong>Mini Two Wheel</strong>
                        <br />Self Balancing <br />
                        Scooter
                      </h3>
                    </div>
                    <span class="price">
                  ...
                  <div class="caption">
                    <div class="banner-info">
                      <h3 class="title">
                        ...
                        <br />
                        at Ultrabooks, <br />
                        Laptops, Tablets <br />Notebooks &amp; <br />More
                      </h3>
                    </div>
                  </div>
                </div>
