<template>
  ...
  <div>
    <!-- showMailDialog -->
    <v-dialog persistent :value="showMailDialog" width="1097px" color="grey" v-if="showMailDialog">
      <v-form ref="form" v-model="valid">
        <v-card>
          <v-card-title>
            <span class="text-h5 sb-grey font-weight-bold mb-2">メール送信</span>
          </v-card-title>
          <v-card-text>
            <v-row>
            ...
            <v-row>
              <v-col class="col-6 pb-0 pt-0">
                <v-alert
                  ...
                  dense
                  border="left"
                  class="mb-0 sb-light-blue"
                >
                  <p class="mb-0">※開封判定を行うためCCとBCCの利用はできません。</p>
                  <p>社内への写しを送信する場合は当アクションの前に社内向けの送信アクションを設定してください。</p>
                </v-alert>
              </v-col>
            </v-row>
              ...
              <v-col class="col-6 text-right">
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-btn class="sb-light-green" outlined v-bind="attrs" v-on="on">
            ...
            <v-row>
              <v-col>
                <h3 class="sb-dark">次導線への移動・確定日時(*)</h3>
              </v-col>
            </v-row>
            <v-row class="d-flex align-center">
              ...
              <v-col cols="1" class="mb-5 pl-0 pr-0">
                <span class="sb-dark">日後</span>
              </v-col>
              ...
              <v-col cols="1" class="mb-5 pl-0">
                <span class="sb-dark">時</span>
              </v-col>
            </v-row>
          </v-card-text>
    ...
    >
      <v-card>
        <v-card-title>
          <span class="text-h5 sb-grey">メールプレビュー</span>
        </v-card-title>
        <v-card-text>
          <v-container>
            <v-row>
              <v-col class="col-12 pb-0 pt-0">
                <v-alert text dense class="mb-0 sb-light-blue">
            ...
            <v-row>
              <v-col cols="col-12 pb-0 pt-0">
                <p class="sb-dark">本文</p>
                <v-alert outlined color="dark" class="ql-editor">
                  <div
            ...
            <v-row>
              <v-col cols="col-12 pb-0 pt-0">
                ...
                <div class="d-flex justify-end">
                  <v-btn class="sb-light-green" outlined @click="confirmSendMail()">
                    このメールを自分宛てにテスト送信する
                  </v-btn>
                </div>
              </v-col>
    ...
    >
      <v-card>
        <v-card-title class="text-h5">
          <span class="sb-grey font-weight-bold">導線の追加</span>
        </v-card-title>
        <v-card-text>
          <v-container>
            <div class="sb-grey">メール結果判断</div>
            <v-row class="grey lighten-5 rounded pa-6">
              <v-col cols="12" md="4" class="mb-0">
                <button
                  class="action mb-5 font-weight-bold"
                  @click="
                    submitFormAction(
                      1,
                      '開封：クリック',
                ...
                <span class="span sb-grey"
                  >メール開封、且つ本文内のURLをクリックした場合</span
                >
              </v-col>
              <v-col cols="12" md="4" class="mb-0">
                <button
              ...
              <v-col cols="12" md="4" class="mb-0">
                ...
                <span class="span sb-grey">メール未開封の場合</span>
              </v-col>
            </v-row>
          </v-container>
        </v-card-text>
        <v-card-actions class="justify-center align-center pb-6">
          <v-btn
            color="grey lighten-3"
            class="justify-center align-center mr-2 font-weight-bold"
            width="120px"
            depressed
            rounded
            @click="closeAction"
...
export default {
  ...
  methods: {
    ...mapGetters(["getSenarioTemplateId", "getCounter", "getEmail"]),
    ...
    submitFormMail() {
      if (!this.$refs.form.validate() || !this.mailData.content) return;
      let json = {
        parentId: this.node,
...
.sb-dark { color: #000000 !important;}
.sb-light-green { color: #6dd400 !important;}
.ql-editor {color: #000000}
.sb-light-blue { color: #2196F3 !important;}
.error-content {
  border: 2px solid #ff5252  ;
}
.error-content .ql-toolbar {
  border-top: none !important;
  border-left: none !important;
  border-right: none !important;
}
.error-content .ql-container {
