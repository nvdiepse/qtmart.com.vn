            ...
            <div class="row contact-info">
                <div class="col-md-9 left-col">
                    <div class="text-block">
                        ...
                        <p>Maecenas dolor elit, semper a sem sed, pulvinar molestie lacus. Aliquam dignissim, elit non
                            mattis ultrices,
                            <br> neque odio ultricies tellus, eu porttitor nisl ipsum eu massa.
                        </p>
                    </div>
                            ...
                            <form class="wpcf7-form" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="wpcf7-form-control-wrap your-message">
                                        <textarea aria-invalid="false" class="wpcf7-form-control wpcf7-textarea" rows="10" cols="40"
                ...
                <div class="col-md-3 store-info">
                    <div class="text-block">
                        ...
                        <h3>Careers</h3>
                        <p class="inner-right-md">If you’re interested in employment opportunities at Techmarket, please
                            email us: <a href="mailto:contact@yourstore.com">contact@yourstore.com</a></p>
                    </div>
                    <!-- .text-block -->
                </div>
                <!-- .col -->
