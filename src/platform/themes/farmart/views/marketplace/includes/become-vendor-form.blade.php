<div class="mb-3">
    ...
    <input class="form-control @if ($isRegister && $errors->has('shop_name')) is-invalid @endif"
        id="shop-name-register" type="text" name="shop_name" placeholder="{{ __('Store Name') }}" value="{{ old('shop_name') }}">
    @if ($isRegister && $errors->has('shop_name'))
...
<div class="form-group mb-3 position-relative">
    ...
    <input class="form-control @if ($isRegister && $errors->has('shop_url')) is-invalid @endif" id="shop-url-register" type="text"
        name="shop_url"
        placeholder="{{ __('Store URL') }}" value="{{ old('shop_url') }}"
        data-url="{{ route('public.ajax.check-store-url') }}">
    @if ($isRegister && $errors->has('shop_url'))
...
<div class="mb-3">
    ...
    <input class="form-control @if ($isRegister && $errors->has('shop_phone')) is-invalid @endif" id="shop-phone-register" type="text" name="shop_phone"
        placeholder="{{ __('Ex: 0943243332') }}">
    @if ($isRegister && $errors->has('shop_phone'))
