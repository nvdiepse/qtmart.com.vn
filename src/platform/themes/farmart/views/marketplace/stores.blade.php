...
<div class="container-xxxl mb-4">
    <div class="row">
        <div class="col-12">
                                ...
                                <div class="store-toolbar__view d-flex align-items-center">
                                    <div class="toolbar-view__icon">
                                        <a class="grid @if ($layout != 'list') active @endif" href="#"
                                            ...
                                            data-class-remove="row-cols-2 store-listing__list"
                                        ...
                                        <a class="list @if ($layout == 'list') active @endif" href="#"
                                            data-layout="list"
                                            data-target=".store-listing-content"
                                            data-class-add="row-cols-2 store-listing__list"
            ...
            <div class="my-4">
                <div class="row @if ($layout == 'list') row-cols-2 store-listing__list @else row-cols-md-4 row-cols-sm-2 row-cols-1 @endif store-listing-content">
                                        ...
                                        <div class="store-data-container row g-1">
                                            <div class="col-12 store-data">
                                                ...
                                                <div class="vendor-store-address mt-3 mb-1">
                                                    ...
                                                    @if ($store->address)
                                                        <span class="street_1">{{ $store->address }}, </span>
                                                    @endif
                                                    ...
                                                    @if ($store->country_name)
                                                        <span class="country">{{ $store->country_name }}</span>
                                                    @endif
                                                </div>
