...
<div class="product-detail-container">
    <div class="bg-light py-5 px-lg-3 px-2">
        <div class="container-xxxl rounded-7 bg-white py-5 px-2 px-md-4 px-lg-5">
            <div class="row">
                <div class="col-lg-5 col-md-12 mb-5 pb-5">
                    ...
                    <div class="product-details">
                        ...
                        @if ($flashSale = $product->latestFlashSales()->first())
                            <div class="deal-expire-date p-4 bg-light mb-2">
                                <div class="row">
                                    <div class="col-xxl-5 d-flex justify-content-center align-items-center">
