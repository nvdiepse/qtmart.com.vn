                ...
                <div class="product-gallery__image item">
                    <a class="img-fluid-eq" href="{{ RvMedia::getImageUrl($img) }}">
                        ...
                        <div class="img-fluid-eq__wrap">
                            <img class="mx-auto" title="{{ $product->name }}" src="{{ image_placeholder() }}" data-lazy="{{ RvMedia::getImageUrl($img) }}">
                        </div>
                    </a>
                </div>
            @empty
            ...
            @forelse ($productImages as $img)
                <div class="item">
                    <div class="border p-1 m-1">
                        <img class="lazyload" title="{{ $product->name }}" src="{{ image_placeholder() }}" data-src="{{ RvMedia::getImageUrl($img, 'thumb') }}">
                    </div>
                </div>
            @empty
                <div class="item">
