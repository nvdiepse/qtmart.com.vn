<div class="form-group">
    ...
    <div class="ui-select-wrapper form-group">
        <select name="is_autoplay" class="ui-select">
            <option value="no"
                    @if (Arr::get($attributes, 'is_autoplay', 'no') == 'no') selected @endif>{{ trans('core/base::base.no') }}</option>
            <option value="yes"
                    @if (Arr::get($attributes, 'is_autoplay', 'no') == 'yes') selected @endif>{{ trans('core/base::base.yes') }}</option>
        </select>
