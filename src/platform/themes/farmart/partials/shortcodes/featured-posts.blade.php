                                    ...
                                    <div class="col-md-4 post-item__image">
                                        <a class="img-fluid-eq" href="{{ $post->url }}">
                                            ...
                                            <div class="img-fluid-eq__wrap">
                                                <img class="lazyload" alt="{{ $post->name }}" src="{{ image_placeholder() }}" data-src="{{ RvMedia::getImageUrl($post->image, 'small', false, RvMedia::getDefaultImage()) }}">
                                            </div>
                                        </a></div>
                            ...
                            <div>
                                @if ($shortcode->app_ios_img && $shortcode->app_ios_link)
                                    <a href="{{ url($shortcode->app_ios_link) }}">
                                        <img class="my-4 mx-2 lazyload" data-src="{{ RvMedia::getImageUrl($shortcode->app_ios_img) }}">
                                    </a>
                                @endif
                                @if ($shortcode->app_android_img && $shortcode->app_android_link)
                                    <a href="{{ url($shortcode->app_android_link) }}">
                                        <img class="my-4 mx-2 lazyload" data-src="{{ RvMedia::getImageUrl($shortcode->app_android_img) }}">
                                    </a>
                                @endif
                            </div>
                        </div>
