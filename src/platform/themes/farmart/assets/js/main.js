...
(function ($) {
    ...
    MartApp.toggleSidebarFilterProducts = function (status = 'close') {
        const $el = $('.catalog-primary-sidebar');
        if (status === 'close') {
                        ...
                        imageHtml += `<div class="product-gallery__image item">
                                <a class="img-fluid-eq" href="${item}">
                                    ...
                                    <div class="img-fluid-eq__wrap">
                                        <img class="mx-auto" title="${data.name}" src="${siteConfig.img_placeholder}" data-lazy="${item}">
                                    </div>
                                </a>
                            </div>`;
                    });
                    ...
                    data.image_with_sizes.thumb.forEach(function (item) {
                        thumbHtml += `<div class="item">
                            <div class="border p-1 m-1">
                                <img class="lazyload" title="${data.name}" src="${siteConfig.img_placeholder}" data-src="${item}" data-lazy="${item}">
                            </div>
                        </div>`;
                    });
