  ...
  methods: {
    ...
    selectProductVariant: function selectProductVariant(product) {
      ...
      if (!_.isEmpty(variation)) {
        ...
        _productItem.product_link = product.product_link;
    ...
    loadStates: function loadStates($event) {
      var context = this;
    ...
    loadCities: function loadCities($event) {
      var context = this;
    ...
    [
                      ...
                      _c("tbody", [
                        _c("tr", [
                          _c("td", { staticClass: "color-subtext" }, [
                            _vm._v(_vm._s(_vm.__("order.amount"))),
                          ]),
                          _vm._v(" "),
                          ...
                          _c("td", [
                            ...
                            _vm.has_applied_discount
                              ? _c("p", { staticClass: "mb0 font-size-12px" }, [
                                  _vm._v(
                                    _vm._s(_vm.child_discount_description)
                                  ),
                                ])
                              : _vm._e(),
                          ]),
                ...
                _c("div", { staticClass: "flexbox-grid-default mt5 mb5" }, [
                  ...
                  _c("div", { staticClass: "flexbox-auto-content" }, [
                    _c("div", { staticClass: "text-upper ws-nm" }, [
                      _vm._v(
                        _vm._s(_vm.__("order.confirm_payment_and_create_order"))
                      ),
                    ]),
                  ]),
                ]),
                                          ...
                                          "\n                                            " +
                                            _vm._s(
                                              address_item.address +
                                                ", " +
                                                address_item.city_name +
                                                ", " +
                                                address_item.state_name +
                                                ", " +
                                                address_item.country_name +
                          ...
                          "a",
                          {
                            ...
                            attrs: {
                              ...
                              href:
                                ...
                                ", " +
                                _vm.child_customer_address.city_name +
                                ", " +
                                _vm.child_customer_address.state_name +
                                ", " +
                                _vm.child_customer_address.country_name +
                                (_vm.zip_code_enabled
                ...
                _c("div", { staticClass: "ui-select-wrapper" }, [
                  _c(
                    ...
                    _vm._l(
                      ...
                      function (shipping_method, shipping_method_key) {
                        return _c(
                          "option",
                          {
                            domProps: {
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("p", [_vm._v(_vm._s(_vm.__("order.select_payment_method")))]),
          _vm._v(" "),
          _c(
            "div",
              ...
              _c(
                ...
                [
                  _c("option", { attrs: { value: "cod" } }, [
                    _vm._v(_vm._s(_vm.__("order.cash_on_delivery_cod"))),
                  ]),
                  _vm._v(" "),
                  _c("option", { attrs: { value: "bank_transfer" } }, [
                    _vm._v(_vm._s(_vm.__("order.bank_transfer"))),
                  ]),
                ]
              ),
              _vm._v(" "),
          ...
          _vm._v(" "),
          _c("p", [
            _vm._v(_vm._s(_vm.__("order.paid_amount")) + " : "),
            _c("span", [
              _vm._v(
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("p", [
            _vm._v(_vm._s(_vm.__("order.pending_amount")) + " : "),
            _c("span", [
              _vm._v(
                _vm._s(_vm._f("formatPrice")(_vm.child_total_amount)) +
                  " " +
