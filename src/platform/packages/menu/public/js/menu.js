...
var MenuNestable = /*#__PURE__*/function () {
  ...
  _createClass(MenuNestable, [{
    ...
    value: function handleNestableMenu() {
      ...
      $(document).on('click', '.dd-item .dd3-content a.show-item-details', function (e) {
        e.preventDefault();
      ...
      $(document).on('change blur keyup', '.nestable-menu .item-details input[type=text], .nestable-menu .item-details select', function (e) {
        e.preventDefault();
      ...
      $(document).on('click', '.box-links-for-menu .btn-add-to-menu', function (e) {
        ...
        if (parent.attr('id') === 'external_link') {
          ...
          $('#menu-node-create-form').find('.form-control').serializeArray().map(function (x) {
            data[x.name] = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(x.value);
          });
          params.push(data);
        } else {
          parent.find('.list-item li.active').each(function (index, el) {
            ...
            params.push({
              reference_type: sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(find_in.attr('data-reference-type')),
              reference_id: sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(find_in.attr('data-reference-id')),
              title: sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(find_in.attr('data-title'))
            });
          });
        }
      ...
      $(document).on('click', '.nestable-menu .item-details .btn-remove', function (e) {
        e.preventDefault();
        var $this = $(e.currentTarget);
        var dd_item = $this.parents('.item-details').parent();
      ...
      $(document).on('click', '.nestable-menu .item-details .btn-cancel', function (e) {
        e.preventDefault();
        var $this = $(e.currentTarget);
        var parent = $this.parents('.item-details').parent();
        parent.find('input[type=text], textarea, select').each(function (index, el) {
    ...
    key: "appendMenuNode",
    value: function appendMenuNode(html, parent) {
      var that = this;
