...
var Vue = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.common.js"); // const axios = require('../services/api');


var app = new Vue({
  el: "#homePage",
  data: {// productDealsOfWeek: [],
  },
  created: function created() {// await this.getProductDealsOfWeek();
  ...
  methods: {// async getProductDealsOfWeek() {
